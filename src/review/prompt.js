function prompt(){
    ...
    prompt += "Use Markdown formatting in your answers." //답변에 마크다운 서식을 사용합니다.
    ...
    prompt += "2. Analyzing the possibility of bugs or issues" //최근 변경 사항의 버그 또는 문제 가능성 분석하기
    ...
    prompt += "Answers must be in Korean" //답변은 한국어로 부탁드립니다
    return prompt
}
module.exports = {
    prompt,
